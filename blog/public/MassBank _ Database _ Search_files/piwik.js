...
if (typeof window.Piwik !== "object") {
    window.Matomo = window.Piwik = (function () {
        var r, b = {}, y = {}, G = document, h = navigator, W = screen, T = window,
            i = T.performance || T.mozPerformance || T.msPerformance || T.webkitPerformance, t = T.encodeURIComponent,
            S = T.decodeURIComponent, l = unescape, I = [], E, e, ad = [], x = 0, m = false;
        ...
        function s(ak) {
            var am = new RegExp("^([a-z]+):"), al = am.exec(ak);
            return al ? al[1] : null
        }

        function d(ak) {
            var am = new RegExp("^(?:(?:https?|ftp):)/*(?:[^@]+@)?([^:/#]+)"), al = am.exec(ak);
            return al ? al[1] : ak
        }
        ...
        function ai(aA) {
            var am = function (aG, aF) {
                    ...
                    return aG
                }, ap, aD, aC, al = [], au = 1732584193, ar = 4023233417, aq = 2562383102, ao = 271733878, an = 3285377520,
        ...
        var v = {
            ...
            buildContentBlock: function (am) {
                ...
                al = this.trim(al);
                an = this.trim(an);
                return {name: ak || "Unknown", piece: al || "Unknown", target: an || ""}
            },
        ...
        function X(al, ar, an) {
            var aq = T.name.split("###"), ap = aq[1], ak = aq[2], ao = aq[3], am = O(al, ar);
        ...
        function Q(b5, b0) {
            var bz = this, a6 = "mtm_consent", cC = "mtm_consent_removed", bV = Y(G.domain, T.location.href, K()),
                cK = L(bV[0]), bE = p(bV[1]), bf = p(bV[2]), cI = false, b9 = "GET", cX = b9,
                aC = "application/x-www-form-urlencoded; charset=UTF-8", co = aC, ay = b5 || "", by = "", cO = "",
                bX = b0 || "", bq = "", bF = "", aX, bb = "",
                cU = ["7z", "aac", "apk", "arc", "arj", "asf", "asx", "avi", "azw3", "bin", "csv", "deb", "dmg", "doc", "docx", "epub", "exe", "flv", "gif", "gz", "gzip", "hqx", "ibooks", "jar", "jpg", "jpeg", "js", "mobi", "mp2", "mp3", "mp4", "mpg", "mpeg", "mov", "movie", "msi", "msp", "odb", "odf", "odg", "ods", "odt", "ogg", "ogv", "pdf", "phps", "png", "ppt", "pptx", "qt", "qtm", "ra", "ram", "rar", "rpm", "sea", "sit", "tar", "tbz", "tbz2", "bz", "bz2", "tgz", "torrent", "txt", "wav", "wma", "wmv", "wpd", "xls", "xlsx", "xml", "z", "zip"],
                ar = [cK], br = [], bC = [], a1 = [], bA = 500, cy, aY, bI, bG, ak,
                ci = ["pk_campaign", "piwik_campaign", "utm_campaign", "utm_source", "utm_medium"],
                bx = ["pk_kwd", "piwik_kwd", "utm_term"], bc = "_pk_", aq = "pk_vid", aS = 180, cM, bh, bJ = false,
                bd = false, cG, a7, bn, cz = 33955200000, cg = 1800000, cT = 15768000000, aV = true, ce = 0, bH = false,
                aJ = false, b2, bN = {}, cd = {}, be = {}, bl = 200, cP = {}, cV = {}, b1 = [], b6 = false, cs = false,
                al = false, cW = false, cD = false, aH = false, a5 = u(), cN = null, b3, aK, bs, bY = ai, bg, aE,
                cj = 0, bm = ["id", "ses", "cvar", "ref"], cr = false, bt = null, cA = [];
            try {
                bb = G.title
            } catch (cp) {
                bb = ""
            ...
            function ax(c7) {
                ...
                var c5 = new RegExp("(^|;)[ ]*" + c7 + "=([^;]*)"), c6 = c5.exec(G.cookie);
                return c6 ? S(c6[2]) : 0
            }
            ...
            function aZ(c6) {
                ...
                var c9 = {type: "application/x-www-form-urlencoded; charset=UTF-8"};
                var c8 = false;
                try {
            ...
            function cf(c5) {
                ...
                b3 = setTimeout(function c6() {
                    ...
                    var c7 = new Date(), c8 = aY - (c7.getTime() - cN);
                    c8 = Math.min(aY, c8);
                    cf(c8)
                }, c5 || aY)
            }
            ...
            function cE() {
                ...
                var c7 = new Date(), c5 = Math.round(c7.getTime() / 1000), c6 = aM("id"), da = ax(c6), c9, c8;
                if (da) {
                    c9 = da.split(".");
                    c9.unshift("0");
                    if (bF.length) {
            ...
            function aR() {
                var dc = cE(), c8 = dc[0], c9 = dc[1], c6 = dc[2], c5 = dc[3], da = dc[4], c7 = dc[5];
                if (!J(dc[6])) {
                    dc[6] = ""
                }
                var db = dc[6];
            ...
            function aB() {
                var c8 = new Date(), c6 = c8.getTime(), c9 = aR().createTs;
            ...
            function aF(c5) {
                ...
                var c7 = new Date(), c6 = Math.round(c7.getTime() / 1000);
                if (!J(c5)) {
                    c5 = aR()
                }
            ...
            function ck(c7, dt, du, c8) {
                var ds, c6 = new Date(), df = Math.round(c6.getTime() / 1000), dc, dr, c9 = 1024, dz, dg, dp = aJ,
                    da = aM("ses"), dm = aM("ref"), dj = aM("cvar"), dk = ax(da), dq = bD(), dw = aX || bE, dd, c5;
                if (bd) {
                    az()
                }
                if (cG) {
            ...
            function bi(c8, c7, dd, c9, c5, dg) {
                var db = "idgoal=0", dc, c6 = new Date(), de = [], df, da = String(c8).length;
                if (da) {
                    db += "&ec_id=" + t(c8);
            ...
            function cl(c9, c5, da, c6) {
                ...
                var c8 = aT(bC, "download"), c7 = aT(a1, "link"),
            ...
            function bu(c7, c9) {
                al = true;
                var c8, c6 = aT(br, "ignore"), da = G.links, c5 = null, db = null;
                if (da) {
